<?php
// https://designmodo.com/wordpress-custom-registration/

class sidedoor_registration_form
{
...
//    private $bio;
    ...
    {
        add_shortcode('sidedoor_registration_form', array($this, 'shortcode'));
...
new sidedoor_registration_form;